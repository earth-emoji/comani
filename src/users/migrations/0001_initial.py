    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acl', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='users', to='users.Acl')),
                ('addresses', models.ManyToManyField(blank=True, related_name='addresses', to='addresses.Address')),
